...
#SBATCH -J "run_17000"   # job name

_p=" >"

db_path="$HOME/fsl_groups/grp_Bio465_GenomeWars/compute/genomeWars/step_2_VecScreen/UniVecDB/UniVec"
query_folder="$HOME/fsl_groups/grp_Bio465_GenomeWars/compute/genomeWars/step_0_data/microbial_genomes_17000/"
results_folder="$HOME/fsl_groups/grp_Bio465_GenomeWars/compute/genomeWars/step_2_VecScreen/run_17000/xml_results"
